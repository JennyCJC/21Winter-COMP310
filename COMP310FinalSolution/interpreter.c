...
int writeCommandEXAM(char *parsedCommand[]){
    ...
    if (parsedCommand[1] == NULL && parsedCommand[2] == NULL ){
        printf("Wrong syntax. The write command requires a file_ID_in_active_file_table and alphanumeric strings separated by spaces as arguments.\n");
        return 1;
    }
    
    if(writeInDisk(atoi(parsedCommand[1]), parsedCommand[2]) == 1){
        return 1;
    }
    return 0;
}
...
int readCommandEXAM(char *parsedCommand[]){
    ...
    readInDisk(atoi(parsedCommand[1]), parsedCommand[2]);
    return 0;
}
...
int openCommandEXAM(char *parsedCommand[]){
    ...
    if (parsedCommand[1] == NULL && parsedCommand[2] == NULL ){
        printf("Wrong syntax. The open command requires a file_ID_in_active_file_table and a file name as arguments.\n");
        return 1;
    }
    

    openInDisk(atoi(parsedCommand[1]), parsedCommand[2]);
...
int closeCommandEXAM(char *parsedCommand[]){
    ...
    // and making needed data structures visible.
    if (parsedCommand[1] == NULL){
        printf("Wrong syntax. The close command requires a file_ID_in_active_file_table.\n");
        return 1;
    }
    
    closeInDisk(atoi(parsedCommand[1]));
    return 0;
}
...
int seekCommandEXAM(char *parsedCommand[]){
    ...
    // and making needed data structures visible.
    if (parsedCommand[1] == NULL && parsedCommand[2] == NULL ){
        printf("Wrong syntax. The open command requires a file_ID_in_active_file_table and a offset as arguments.\n");
        return 1;
    }
    
    seekInDisk(atoi(parsedCommand[1]), atoi(parsedCommand[2]));
    return 0;    
}

int chmodCommandEXAM(char *parsedCommand[]){
    if (parsedCommand[1] == NULL && parsedCommand[2] == NULL && parsedCommand[3] == NULL){
        printf("Wrong syntax. The open command requires a file_ID_in_active_file_table, a read permission, and a write permission as arguments.\n");
        return 1;
    }
    
    chmodInDisk(atoi(parsedCommand[1]), parsedCommand[2], parsedCommand[3]);
    return 0;
}
